...
(define (make-sum a1 . a2)(if (> (length a2) 1)
                             (cond ((=number? a1 0) (append (list '+) a2))
...
(define (make-product a1 . a2) (if(> (length a2) 1)
                                  (cond (( or (=number? a1 0) (coutain? a2 0)) 0)
                                        ((=number? a1 1) (append(list '*) a2))
                                        (else (append (list '* a1) a2)))
                                (let((a2(car a2)))
...
(define (multiplicand s) (if (> (length s) 3) (append (list '*) (cddr s)) (caddr s)))
